...
async function buildProject(root, version) {
    ...
    if ((0, os_1.platform)() === 'darwin') {
        return [
            ...
            { path: (0, path_1.join)(artifactsPath, `macos/Grades.app`), name: `grades_${version}.app` },
            { path: (0, path_1.join)(artifactsPath, `macos/Grades.app.tar.gz`), name: `grades_${version}.app.tar.gz` },
            { path: (0, path_1.join)(artifactsPath, `macos/Grades.app.tar.gz.sig`), name: `grades_${version}.app.tar.gz.sig` }
        ];
    }
    else if ((0, os_1.platform)() === 'win32') {
        return [
            { path: (0, path_1.join)(artifactsPath, `msi/Grades_${version}_x64_en-US.msi`), name: `grades_${version}_x64_en-US.msi` },
            { path: (0, path_1.join)(artifactsPath, `msi/Grades_${version}_x64_en-US.msi.zip`), name: `grades_${version}_x64_en-US.msi.zip` },
            { path: (0, path_1.join)(artifactsPath, `msi/Grades_${version}_x64_en-US.msi.zip.sig`), name: `grades_${version}_x64_en-US.msi.zip.sig` }
        ];
    }
    else {
        return [
            { path: (0, path_1.join)(artifactsPath, `deb/grades_${version}_amd64.deb`), name: `grades_${version}_amd64.deb` },
            { path: (0, path_1.join)(artifactsPath, `appimage/grades_${version}_amd64.AppImage`), name: `grades_${version}_amd64.AppImage` },
            { path: (0, path_1.join)(artifactsPath, `appimage/grades_${version}_amd64.AppImage.tar.gz`), name: `grades_${version}_amd64.AppImage.tar.gz` },
            { path: (0, path_1.join)(artifactsPath, `appimage/grades_${version}_amd64.AppImage.tar.gz.sig`), name: `grades_${version}_amd64.AppImage.tar.gz.sig` }
        ];
    }
}
